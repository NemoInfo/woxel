...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{Render in ray mode using (a) HDDA and (b) HDDA+SDF of the teapot model from a 1000m distance. The model resolution is $981\times462\times617$. As in \cref{rendermods}(b), the colour of pixels is determined based on the steps the ray took to intersect the model. The maximum is 200 steps, which corresponds to bright red.}
  \label{teacomp}
\end{figure}
